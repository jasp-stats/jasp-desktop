...
.setColumnDataAsScale <- function(x) return(x)
.setColumnDataAsOrdinal <- function(x) return(x)
.setColumnDataAsNominal <- function(x) return(x)
.setColumnDataAsNominalText <- function(x) return(x)
