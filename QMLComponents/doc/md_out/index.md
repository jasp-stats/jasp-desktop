...
Welcome to the JASP QML Reference documentation. This library contains
the custom controls used to build JASP analysis modules.
...
See the JASP.Controls module for all available types.

## All Controls

**[A](#a) [B](#b) [C](#c) [D](#d) [F](#f) [G](#g) [H](#h) [I](#i) [J](#j) [L](#l) [M](#m) [P](#p) [R](#r) [S](#s) [T](#t) [V](#v) **
