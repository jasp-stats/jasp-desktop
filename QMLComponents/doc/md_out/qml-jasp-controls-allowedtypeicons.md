...
# AllowedTypeIcons QML Type

Internal component that displays variable type filter icons.
[More...](#details)
...
- **iconModel** (var) - Model of icon source paths to display.
- **count** (int) - Number of icons currently shown.
