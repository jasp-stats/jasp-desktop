...
const Version AppInfo::version = Version(0, 16, 0, 0);
...
const std::string AppInfo::gitBranch = xstr("(git rev-parse --abbrev-ref HEAD)");
const std::string AppInfo::gitCommit = xstr("(git rev-parse --verify HEAD)");
