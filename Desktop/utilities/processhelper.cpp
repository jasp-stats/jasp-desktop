...
#undef ARCH_SUBPATH
	...
	env.insert("R_LIBS",			programDir.absoluteFilePath("Modules/Tools/R_cpp_includes_library") + ";" + programDir.absoluteFilePath("Modules/Tools/jaspRoboReport_library") + ";" + _R_HOME + "/library");
	...
	env.insert("R_LIBS",			programDir.absoluteFilePath("../Modules/Tools/R_cpp_includes_library") + ":" + programDir.absoluteFilePath("../Modules/Tools/jaspRoboReport_library") + ":" + rHome.absoluteFilePath("library") + ":" + programDir.absoluteFilePath("R/library") + custom_R_library);
...
#elif FLATPAK_USED
	env.insert("R_HOME",			rHome.absolutePath());
	env.insert("R_LIBS",			"/app/Modules/Tools/R_cpp_includes_library:/app/Modules/Tools/jaspRoboReport_library:/app/lib64/R/library" + custom_R_library);
	env.insert("LD_LIBRARY_PATH",	"/app/Modules/Tools/R_cpp_includes_library/RInside/lib/:/app/lib64/R/lib/");
#else  // linux
	env.insert("R_HOME",			rHome.absolutePath());
	env.insert("R_LIBS",			programDir.absoluteFilePath("../Modules/Tools/R_cpp_includes_library") + ":" + programDir.absoluteFilePath("../Modules/Tools/jaspRoboReport_library") + ":" + programDir.absoluteFilePath("R/library") + custom_R_library);
#endif
