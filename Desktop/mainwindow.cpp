...
void MainWindow::makeConnections()
{
	...
	connect(_package,				&DataSetPackage::newDataLoaded,						this,					[this]() { populateUIfromDataSet(); }							);
...
bool MainWindow::startDataEditorHandler()
{
	...
	{
		bool manualEditsMode = _package->manualEdits() && !dataFilePath.isEmpty() && !_package->dataFileReadOnly();
