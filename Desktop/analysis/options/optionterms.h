...
public:
			...
			{
				setShouldEncode(true); //Maybe we should check if the terms are in fact columnnames or not? But, for now I will just assume that terms are very likely to contain columnnames. And otherwise Ill have to override asMetaJson and step through all this like in OptionTerms::asJSON() and simply check it
			}
