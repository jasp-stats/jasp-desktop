...
{
	if(_dataSet)
		resetDataSet(false); //no dbDelete necessary cause we just copied an old sqlite file here from the JASP file
...
void DataSetPackage::resetDataSet(bool reCreate)
{
