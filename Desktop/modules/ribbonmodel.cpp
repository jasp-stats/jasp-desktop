...
void RibbonModel::addSpecialRibbonButtonsEarly()
{
	...
	_entriesInsert = 
	{
		new AnalysisEntry([&](){}, fq(tr("Insert column before")),	true,		"menu-column-insert-before"),
		new AnalysisEntry([&](){}, fq(tr("Insert column after")),	true,		"menu-column-insert-after"),
		new AnalysisEntry([&](){}, fq(tr("Insert row before")),		true,		"menu-row-insert-before"),
		new AnalysisEntry([&](){}, fq(tr("Insert row after")),		true,		"menu-row-insert-after")
	};
	
	_entriesDelete =
	{
		new AnalysisEntry([&](){}, fq(tr("Delete column")),			true,		"menu-column-remove"),
		new AnalysisEntry([&](){}, fq(tr("Delete row")),				true,		"menu-row-remove")
	};
