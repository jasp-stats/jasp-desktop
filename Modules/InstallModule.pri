...
#	win32:  Install$${MODULE_NAME}.commands       += IF NOT EXIST \"$$JASP_LIBRARY_DIR\"				( mkdir \"$$JASP_LIBRARY_DIR\") ;							$$escape_expand(\\n\\t)
	...
	JAGS_ROOT = $${JASP_BUILDROOT_DIR}/JAGS
	
macx   { JAGS_MAC_HELPER=", JAGS_PREFIX=\'$$JASP_BUILDROOT_DIR\', JAGS_INCLUDEDIR=\'$$JAGS_ROOT/include\', JAGS_LIBDIR=\'$$JAGS_ROOT/\'" 
} else { JAGS_MAC_HELPER="" }

	SETTING_UP_RENV= "Sys.setenv(RENV_PATHS_ROOT=\'$$MODULES_RENV_ROOT\', RENV_PATHS_CACHE=\'$$MODULES_RENV_CACHE\', JAGS_ROOT=\'$$JAGS_ROOT\'$$JAGS_MAC_HELPER);"
