...
test_that("Main table results match", {
  ...
  results <- jasptools::run("Descriptives", mydat, options)
  table <- results[["results"]][["stats"]][["data"]]
  expect_equal_tables(table,
    list(1.89652072756094, 0, 3.356094448, -0.120135614827586, -0.2223981035,
				 -2.336742886, 0, -2.336742886, 0.003420008111500635, 5.692837334, 
				 0.9335474446656983, 0.885861572513177,
				 ...
				 -3.023963827, 0, -3.023963827, 0.4017058546339092, 5.203384953, 
				 0.9725864240885143, 0.166587887409046,
