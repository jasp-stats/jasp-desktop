...
test_that("Main table results match", {
  ...
  expect_equal_tables(table,
    list("contNormal", "Student", 98, 0.448976320466698, 0.163364220743842,
         0.15401876311258, -0.263105943067512, 0.589834384555196, -0.244064746209808,
         0.551319670653121, 0.214904085649005, 0.760172707980336, 1, "contNormal", "Welch",
         93.4114683704755, 0.441326472332004, 0.163364220743842, 0.155340050635411,
         -0.256150680877671, 0.582879122365355, -0.242805192811962, 0.552657418835942, 0.211269449004155,
