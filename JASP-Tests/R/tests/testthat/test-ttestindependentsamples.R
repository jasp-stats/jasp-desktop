...
test_that("Main table results match", {
  ...
  expect_equal_tables(table,
    list("contNormal", "Student", 98, 0.448976320466698, 0.163364220743842,
         0.15401876311258, -0.244064746209808, 0.551319670653121, 0.214904085649005, 
         0.760172707980336, 1, "contNormal", "Welch", 93.4114683704755, 0.441326472332004, 
         0.163364220743842, 0.155340050635411, -0.242805192811962, 0.552657418835942, 
         0.211269449004155, 0.773250564688269, 1, "contNormal", "Mann-Whitney", "", 
         0.617539087467476, 0.0932984248674163, 0.0591133004926108,
         -0.169577908162339, 0.281763520076616, "", 1290, 1)
  )
})
