...
test_that("Descriptive Statistics table results match", {
  ...
  expect_equal_tables(table,
                      list(240, 19.408242222006, 20.7583333333333, 0.685, 22.1084244446606,
                           "prenumb", 240, 27.8493219981947, 29.45, 0.813, 31.0506780018053,
                           "postnumb", 240, -9.89599389735516, -8.69166666666667, 0.61446395963807,
