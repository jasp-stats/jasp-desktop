...
test_that("Descriptive Statistics table results match", {
  ...
  expect_equal_tables(table,
                      list(240, 19.408, 20.7583333333333, 10.6173425930313, 0.685, 22.108,
                           "prenumb", 240, 27.849, 29.45, 12.5879998643857, 0.813, 31.051,
                           "postnumb", 240, -9.896, -8.69166666666667, 9.51923473009165,
                           0.61446395963807, -7.487, "prenumb - postnumb"))
})