...
.expectedPackages <- function() 
{
  ...
  #--auto-generated
	...
	expected <- rbind(expected, c('KneeArrower', '0.1.0'))
	...
	expected <- rbind(expected, c('NetworkToolbox', '1.3.1'))
	...
	expected <- rbind(expected, c('Rcpp', '1.0.2'))
	expected <- rbind(expected, c('RcppArmadillo', '0.9.700.2.0'))
	...
	expected <- rbind(expected, c('afex', '0.25-1'))
	...
	expected <- rbind(expected, c('car', '3.0-3'))
	...
	expected <- rbind(expected, c('cmprsk', '2.2-8'))
	...
	expected <- rbind(expected, c('data.table', '1.12.2'))
	expected <- rbind(expected, c('datasets', '3.6.1'))
	expected <- rbind(expected, c('dbscan', '1.1-4'))
	expected <- rbind(expected, c('deSolve', '1.24'))
	expected <- rbind(expected, c('digest', '0.6.21'))
	...
	expected <- rbind(expected, c('emmeans', '1.4.1'))
	...
	expected <- rbind(expected, c('glmnet', '2.0-18'))
	expected <- rbind(expected, c('glue', '1.3.1'))
	expected <- rbind(expected, c('gnm', '1.1-0'))
	expected <- rbind(expected, c('goftest', '1.1-1'))
	...
	expected <- rbind(expected, c('huge', '1.3.3'))
	...
	expected <- rbind(expected, c('jomo', '2.6-9'))
	expected <- rbind(expected, c('jpeg', '0.1-8'))
	expected <- rbind(expected, c('jsonlite', '1.6'))
	expected <- rbind(expected, c('kernlab', '0.9-27'))
	...
	expected <- rbind(expected, c('lme4', '1.1-21'))
	expected <- rbind(expected, c('lmerTest', '3.1-0'))
	expected <- rbind(expected, c('lmtest', '0.9-37'))
	expected <- rbind(expected, c('logspline', '2.1.14'))
	...
	expected <- rbind(expected, c('openxlsx', '4.1.0.1'))
	...
	expected <- rbind(expected, c('purrr', '0.3.2'))
	...
	expected <- rbind(expected, c('quantreg', '5.51'))
	expected <- rbind(expected, c('qvcalc', '1.0.0'))
	...
	expected <- rbind(expected, c('shiny', '1.3.2'))
	expected <- rbind(expected, c('shinyAce', '0.4.1'))
