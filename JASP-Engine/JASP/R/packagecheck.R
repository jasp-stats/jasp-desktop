...
.expectedPackages <- function() 
{
  ...
  #--auto-generated
	expected <- rbind(expected, c('BAS', '1.5.4'))
	...
	expected <- rbind(expected, c('bstats', '0.0.0.9001'))
	...
	expected <- rbind(expected, c('emmeans', '1.4.2'))
	...
	expected <- rbind(expected, c('flexplot', '0.7.2'))
	...
	expected <- rbind(expected, c('rstan', '2.19.2'))
