...
#--auto-generated
	...
	expected <- rbind(expected, c('JASPgraphs', '0.1.0'))
	expected <- rbind(expected, c('KernSmooth', '2.23-15'))
	expected <- rbind(expected, c('MASS', '7.3-47'))
	...
	expected <- rbind(expected, c('Rcpp', '0.12.14'))
	...
	expected <- rbind(expected, c('car', '2.1-6'))
	...
	expected <- rbind(expected, c('curl', '3.0'))
	...
	expected <- rbind(expected, c('glmnet', '2.0-13'))
	...
	expected <- rbind(expected, c('htmlTable', '1.11.0'))
	...
	expected <- rbind(expected, c('irlba', '2.3.1'))
	...
	expected <- rbind(expected, c('lmerTest', '2.0-36'))
	...
	expected <- rbind(expected, c('lsmeans', '2.27-61'))
	...
	expected <- rbind(expected, c('plotrix', '3.7'))
	...
	expected <- rbind(expected, c('quantmod', '0.4-12'))
	expected <- rbind(expected, c('quantreg', '5.34'))
	expected <- rbind(expected, c('qvcalc', '0.9-1'))
	expected <- rbind(expected, c('relaimpo', '2.2-2'))
	expected <- rbind(expected, c('relimp', '1.0-5'))
	expected <- rbind(expected, c('reshape2', '1.4.2'))
	expected <- rbind(expected, c('rjson', '0.2.15'))
	expected <- rbind(expected, c('rlang', '0.1.4'))
	...
	expected <- rbind(expected, c('stringi', '1.1.6'))
	expected <- rbind(expected, c('stringr', '1.2.0'))
	expected <- rbind(expected, c('survey', '3.32-1'))
	expected <- rbind(expected, c('survival', '2.40-1'))
	expected <- rbind(expected, c('tcltk', '3.3.3'))
	expected <- rbind(expected, c('tibble', '1.3.4'))
	expected <- rbind(expected, c('tidyr', '0.7.2'))
	expected <- rbind(expected, c('tidyselect', '0.2.3'))
	...
	expected <- rbind(expected, c('yaml', '2.1.15'))
