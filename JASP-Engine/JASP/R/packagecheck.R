...
#--auto-generated
	...
	expected <- rbind(expected, c('BDgraph', '2.44'))
	...
	expected <- rbind(expected, c('Rcpp', '0.12.16.1'))
	...
	expected <- rbind(expected, c('afex', '0.19-1'))
	...
	expected <- rbind(expected, c('curl', '3.1'))
	...
	expected <- rbind(expected, c('emmeans', '1.1.2'))
	...
	expected <- rbind(expected, c('htmlwidgets', '1.0'))
	expected <- rbind(expected, c('httpuv', '1.3.6.2'))
	...
	expected <- rbind(expected, c('lme4', '1.1-15'))
	...
	expected <- rbind(expected, c('pillar', '1.2.1'))
	...
	expected <- rbind(expected, c('shinyAce', '0.2.1'))
	...
	expected <- rbind(expected, c('stringi', '1.1.7'))
	expected <- rbind(expected, c('stringr', '1.3.0'))
	...
	expected <- rbind(expected, c('tseries', '0.10-43'))
	...
	expected <- rbind(expected, c('viridis', '0.5.0'))
