...
#--auto-generated
	...
	expected <- rbind(expected, c('BDgraph', '2.41'))
	...
	expected <- rbind(expected, c('mgm', '1.2-1'))
	...
	expected <- rbind(expected, c('quantmod', '0.4-11'))
	...
	expected <- rbind(expected, c('tidyselect', '0.2.2'))
