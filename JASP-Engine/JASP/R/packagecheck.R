...
#--auto-generated
	...
	expected <- rbind(expected, c('afex', '0.22-1'))
	...
	expected <- rbind(expected, c('dplyr', '0.7.8'))
	...
	expected <- rbind(expected, c('evaluate', '0.12'))
	...
	expected <- rbind(expected, c('haven', '2.0.0'))
	expected <- rbind(expected, c('highr', '0.7'))
	expected <- rbind(expected, c('hmeasure', '1.0-1'))
	...
	expected <- rbind(expected, c('igraph', '1.2.2'))
	...
	expected <- rbind(expected, c('later', '0.7.5'))
	...
	expected <- rbind(expected, c('onewaytests', '1.9'))
	...
	expected <- rbind(expected, c('progress', '1.2.0'))
	...
	expected <- rbind(expected, c('readxl', '1.2.0'))
	...
	expected <- rbind(expected, c('rlang', '0.3.1'))
	...
	expected <- rbind(expected, c('xfun', '0.4'))
