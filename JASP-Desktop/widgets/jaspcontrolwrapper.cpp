...
JASPControlWrapper* JASPControlWrapper::buildJASPControlWrapper(JASPControlBase* control)
{
	...
	switch(controlType)
	{
	case JASPControlBase::ControlType::CheckBox:			//fallthrough:
	case JASPControlBase::ControlType::Switch:						controlWrapper		= new BoundQMLCheckBox(control);					break;
	...
	case JASPControlBase::ControlType::VariablesListView:
	{
		...
		case qmlListViewType::Pairs:				controlWrapper = new BoundQMLListViewPairs(control);			break;
