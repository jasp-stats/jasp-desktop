...
JASPWidgets.tableView = JASPWidgets.View.extend({
	...
	render: function () {
		...
		chunks.push('<thead>')
		chunks.push('<tr>')
		chunks.push('<th colspan="' + 2 * columnCount + '">' + optTitle + '<div class="toolbar do-not-copy"><div class="status"></div><div class="copy toolbar-button" style="visibility: hidden ;"></div><div class="cite toolbar-button" style="visibility: hidden ;"></div></div>')
		...
		var $toolbar = this.$el.find("div.toolbar")
...
/*$.widget("jasp.table", {
	...
	_symbol : function(index) {
		...
		return ("\u1D43\u1D47" + "\u1D48\u1D49\u1DA0\u1D4D\u02B0\u2071\u02B2\u1D4F\u02E1\u1D50\u207F\u1D52\u1D56\u02B3\u02E2\u1D57\u1D58\u1D5B\u02B7\u02E3\u02B8\u1DBB").charAt(index)
