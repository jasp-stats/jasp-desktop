...
JASPControl
{
	id:							networkFactorsList
	controlType:				"NetworkFactorsList"
	width:						parent.width
	implicitWidth:				width
	...
	Text
	{
		...
		text:			networkFactorsList.title
		height:			networkFactorsList.title ? 20 * preferencesModel.uiScale : 0
		font:			Theme.font
	...
	Rectangle
	{
		...
		anchors.left:	parent.left
		height:			networkFactorsList.height - text.height
		width:			parent.width
		...
		GridView
		{
			...
			model:				networkFactorsList.model
