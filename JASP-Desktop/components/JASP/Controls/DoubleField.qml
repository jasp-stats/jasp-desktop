...
TextField
{
	...
	property string inclusive:			"yes"
					...
					inputType:			"number"
					validator:			JASPDoubleValidator { id: doubleValidator; bottom: min; top: max ; decimals: decimals; inclusive: doubleField.inclusive; notation: DoubleValidator.StandardNotation }
