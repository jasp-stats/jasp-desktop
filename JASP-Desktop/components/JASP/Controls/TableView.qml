...
JASPControl
{
	...
	readonly property int editableColumnStartIndex: tableView.modelType === "FilteredDataEntryModel" ? tableView.columnCount - 1 : (tableView.modelType === "JAGSDataInputModel" && tableView.tableType == "initialValues" ? 1 : 0)
