// Taken from TableViewStyle.qml from Qt 5.10 to remove some mouse-stealing on the headers to allow us to use buttons there.
/****************************************************************************
**
...
ScrollViewStyle {
    ...
    readonly property BasicTableViewJasp control: __control
    ...
    property Component rowNumberDelegate: Text
    {
        text: styleData.row
