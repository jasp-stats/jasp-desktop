...
#include "mlclusteringrandomforestform.h"
#include "ui_mlclusteringrandomforestform.h"

MLClusteringRandomForestForm::MLClusteringRandomForestForm(QWidget *parent) :
	AnalysisForm("MLClusteringRandomForestForm", parent),
	ui(new Ui::MLClusteringRandomForestForm)
{
	ui->setupUi(this);
...
MLClusteringRandomForestForm::~MLClusteringRandomForestForm()
{
	delete ui;
}

void MLClusteringRandomForestForm::defaultOptions()
{
...
void MLClusteringRandomForestForm::bindTo(Options *options, DataSet *dataSet)
{
...
void MLClusteringRandomForestForm::factorsChanging()
{
	if (_options != NULL)
		_options->blockSignals(true);
}

void MLClusteringRandomForestForm::factorsChanged()
{
	if (_options != NULL)
		_options->blockSignals(false);
}

void MLClusteringRandomForestForm::on_manual_1_clicked(bool checked)
{
	if (checked) {
...
void MLClusteringRandomForestForm::on_auto_1_clicked(bool checked)
{
	if (checked) {
		ui->numberOfTrees->hide();
	}
...
void MLClusteringRandomForestForm::on_manual_2_clicked(bool checked)
{
	if (checked) {
...
void MLClusteringRandomForestForm::on_auto_2_clicked(bool checked)
{
	if (checked) {
		ui->numberOfPredictors->hide();
	}
...
void MLClusteringRandomForestForm::on_manual_3_clicked(bool checked)
{
	if (checked) {
...
void MLClusteringRandomForestForm::on_auto_3_clicked(bool checked)
{
	if (checked) {
		ui->percentageDataBootstrap->hide();
	}
...
void MLClusteringRandomForestForm::on_manual_4_clicked(bool checked)
{
	if (checked) {
...
void MLClusteringRandomForestForm::on_auto_4_clicked(bool checked)
{
	if (checked) {
		ui->percentageDataTraining->hide();
	}
...
void MLClusteringRandomForestForm::on_manual_5_clicked(bool checked)
{
	if (checked) {
		ui->seed->show();
	}
...
void MLClusteringRandomForestForm::on_auto_5_clicked(bool checked)
{
	if (checked) {
		ui->seed->hide();
	}
...
void MLClusteringRandomForestForm::on_manual_6_clicked(bool checked)
{
	if (checked) {
...
void MLClusteringRandomForestForm::on_auto_6_clicked(bool checked)
{
	if (checked) {
		ui->modelMinimumTerminalNode->hide();
	}
...
void MLClusteringRandomForestForm::on_manual_7_clicked(bool checked)
{
	if (checked) {
...
void MLClusteringRandomForestForm::on_auto_7_clicked(bool checked)
{
	if (checked) {
		ui->modelMaximumTerminalNode->hide();
	}
