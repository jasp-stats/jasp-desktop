...
#ifndef MLREGRESSIONRANDOMFORESTFORM_H
#define MLREGRESSIONRANDOMFORESTFORM_H
...
namespace Ui {
class MLRegressionRandomForestForm;
}


class MLRegressionRandomForestForm : public AnalysisForm
{
	Q_OBJECT

public:
	explicit MLRegressionRandomForestForm(QWidget *parent = 0);
	~MLRegressionRandomForestForm();
	void bindTo(Options *options, DataSet *dataSet) OVERRIDE;
	void defaultOptions();

private:
	Ui::MLRegressionRandomForestForm *ui;
...
#endif // MLREGRESSIONRANDOMFORESTFORM_H
