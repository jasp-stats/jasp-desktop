...
#ifndef MLCLASSIFICATIONKNNFORM_H
#define MLCLASSIFICATIONKNNFORM_H
...
namespace Ui {
class MLClassificationKNNForm;
}


class MLClassificationKNNForm : public AnalysisForm
{
	Q_OBJECT

public:
	explicit MLClassificationKNNForm(QWidget *parent = 0);
	~MLClassificationKNNForm();
	void bindTo(Options *options, DataSet *dataSet) OVERRIDE;
	void defaultOptions();

private:
	Ui::MLClassificationKNNForm *ui;
