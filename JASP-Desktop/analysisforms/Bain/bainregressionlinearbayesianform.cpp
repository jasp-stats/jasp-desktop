...
void BainRegressionLinearBayesianForm:: bindTo(Options *options, DataSet *dataSet)
{
...
void BainRegressionLinearBayesianForm::factorsChanging()
{
	if (_options != NULL)
		_options->blockSignals(true);
}

void BainRegressionLinearBayesianForm::factorsChanged()
{
	if (_options != NULL)
