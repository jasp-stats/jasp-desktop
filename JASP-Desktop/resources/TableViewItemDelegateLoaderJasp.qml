// Taken from TableViewColumnJaspJasp.qml from Qt 5.10 to add a resizefunction that also includes the headers implicit width
/****************************************************************************
**
...
/*!
    \qmltype TableViewItemDelegateLoaderJasp
    \internal
    \qmlabstract
...
Loader {
    ...
    property TableViewColumnJasp __column: null
