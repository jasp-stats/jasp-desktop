...
Item {
    ...
    Image {
        ...
        visible: operatorImageSource !== "" && (operator !== "/"
                                                || !acceptsDrops)
    ...
    Item {
        ...
        width: Math.max(
                   leftDrop.width + marginStripe,
                   rightDrop.width + marginStripe,
                   opStripe.visible ? filterConstructor.blockDim : opText.contentWidth)
