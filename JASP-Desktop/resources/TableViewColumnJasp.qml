// Taken from TableViewColumnJasp.qml from Qt 5.10 to add a resizefunction that also includes the headers implicit width
/****************************************************************************
**
...
/*!
    ...
    TableViewColumnJasp represents a column within a TableView or a TreeView. It provides
    properties to decide how the data in that column is presented.

    \qml
    TableViewJasp {
        TableViewColumnJasp { role: "title"; title: "Title"; width: 100 }
        TableViewColumnJasp { role: "author"; title: "Author"; width: 200 }
        model: libraryModel
    }
    \endqml

    \sa TableViewJasp//, TreeView
*/
...
QtObject {
    ...
    */
    ...
    /*! The current implicitWidth of the column, used in resize function.
    Should be taken from the headerStyle, default value is 0.
    */
    ...
    /*! \qmlproperty enumeration TableViewColumnJasp::elideMode
    ...
    /*! \qmlproperty enumeration TableViewColumnJasp::horizontalAlignment
    ...
    of a \l TableViewJasp// or \l TreeView for a specific column.
    ...
    */
    ...
    /*! \qmlmethod void TableViewColumnJasp::resizeToContents()
        Resizes the column so that the implicitWidth of the contents on every row will fit.
        \since QtQuick.Controls 1.2 */
    function resizeToContents() { this.resizeToContentsWithMinimumWidth(0) }

    /*! \qmlmethod void TableViewColumnJasp::resizeToContentsWithMinimumWidth(includeHeader)
        Resizes the column so that the implicitWidth of the contents on every row will fit.
        If includeHeader is set to true it will also use the implicitWidth of the header. */
    function resizeToContentsWithMinimumWidth(minWidth) {
        ...
        // with the expected object it should point to in BasicTableViewJasp.
