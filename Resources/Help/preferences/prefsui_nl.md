...
## Lettertype
Hier kun je aangeven welke lettertype wordt gebruikt door de interface (file menu, ribbon bar en analysisopties paneel), de R, Lavaan of JAGS code, of de analyseresultaat paneel. Als je geen keuze maakt, de standaard lettertype wordt gebruikt.
