...
Demonstratie van de inverse gammaverdeling.

## Toon distributie

Geeft theoretische inverse gammaverdeling weer, met opgegeven parameterwaarden.

### Parameters

- k, &theta;: De inverse gammadistributie wordt gespecificeerd met behulp van de vorm- en schaalparameters
- &alpha;, &beta;: De Inverse Gamma-verdeling wordt gespecificeerd met behulp van de vorm- en snelheidsparameters
- k, &mu;: De Inverse Gamma-verdeling wordt gespecificeerd met behulp van de vorm en gemiddelde parameters
