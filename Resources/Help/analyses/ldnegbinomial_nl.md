...
Demonstratie van de negatieve binomiaalverdeling.

## Toon distributie

Geeft theoretische negatieve binominaal verdeling weer, gegeven gespecificeerde parameterwaarden.

### Parameters

- &phi;, p: De negatieve binominaalverdeling wordt gespecificeerd op basis van het aantal successen en de waarschijnlijkheid van succesparameters
- &phi;, &mu;: De negatieve binominaalverdeling wordt gespecificeerd met behulp van de spreiding en gemiddelde parameters
