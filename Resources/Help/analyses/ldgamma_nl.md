...
Demonstratie van de Gammaverdeling.

## Toon distributie

Geeft de theoretische gammaverdeling weer, gegeven de opgegeven parameterwaarden.

### Parameters

- k, &theta;: De Gamma-verdeling wordt gespecificeerd met behulp van de vorm- en schaalparameters
- &alpha;, &beta: De Gamma-verdeling wordt gespecificeerd met behulp van de vorm- en snelheidsparameters
- k, &mu;: De gammadistributie wordt gespecificeerd met behulp van de vorm- en gemiddelde parameters
