...
Expositie van de Poisson verdeling.

## Toon Verdeling
Geeft de theoretische Poisson verdeling weer, met opgegeven parameterwaarden.

### Parameter
- &lambda;: De snelheids-/intensiteitsparameter regelt het aantal stochastistische gebeurtenis (evenementen) in een tijdseenheid.
