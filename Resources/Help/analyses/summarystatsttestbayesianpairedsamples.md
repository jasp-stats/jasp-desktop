Summary Statistics Bayesian Paired samples T-Test
==================

This function allows you to compute Bayes factor corresponding to paired groups t-test using the classical *t* statistic. The null hypothesis states that the population mean of the difference between paired observations equals 0. This Bayesian assessment can be executed in the absence of the raw data.
