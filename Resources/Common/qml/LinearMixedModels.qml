...
Form {
    ...
    ExpanderButton {
        ...
        VariablesForm {
            ...
            availableVariablesList {
                ...
                name: "components"
                syncModels: ["fixedFactors", "fixedCovariates"]
            }
            defaultAssignedVariablesList {
    ...
    ExpanderButton {
        ...
        VariablesForm {
            height: 170
            availableVariablesList {        title: qsTr("Factors")          ; name: "descriptivePlotsVariables" ; syncModels: ["fixedFactors", "randomFactors"] }
        ...
        GridLayout {
            ButtonGroup {
                ...
                RadioButton { text: qsTr("None"); name: "displayNone"; checked: true }
                RadioButton { text: qsTr("Confidence Interval"); name: "confidenceInterval"; id: confidenceInterval }
