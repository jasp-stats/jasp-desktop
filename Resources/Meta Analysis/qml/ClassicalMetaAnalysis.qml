...
Form
{
	...
	VariablesForm
	{
		...
		AssignedVariablesList { name: "dependent";	title: qsTr("Effect Size"); singleVariable: true; allowedColumns: ["scale"] }
		AssignedVariablesList { name: "wlsWeights";	title: qsTr("Effect Size Standard Error"); singleVariable: true; allowedColumns: ["scale"] }
		...
		AssignedVariablesList { name: "studyLabels";	title: qsTr("Study Labels"); singleVariable: true; allowedColumns: ["nominal","ordinal"] }
		AssignedVariablesList { name: "covariates";	title: qsTr("Covariates"); singleVariable: false; allowedColumns: ["scale"] }
		AssignedVariablesList { name: "factors";	title: qsTr("Factors"); singleVariable: false; allowedColumns: ["ordinal", "nominal"] }
	}
