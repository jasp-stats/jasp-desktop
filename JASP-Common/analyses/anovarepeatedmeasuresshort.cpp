...
#include "anovarepeatedmeasuresshort.h"
...
AnovaRepeatedMeasuresShort::AnovaRepeatedMeasuresShort(int id)
	: Analysis(id, "AnovaRepeatedMeasuresShort", createOptions())
{
}

Options *AnovaRepeatedMeasuresShort::createOptions() const
{
