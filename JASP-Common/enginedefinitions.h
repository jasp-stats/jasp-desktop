...
DECLARE_ENUM(engineState,			idle, analysis, filter, rCode, computeColumn, moduleRequest, pauseRequested, paused, resuming, stopRequested, stopped);
...
DECLARE_ENUM(moduleStatus,			uninitialized, installNeeded, installModPkgNeeded, installReqPkgsNeeded, loadingNeeded, unloadingNeeded, readyForUse, error);
