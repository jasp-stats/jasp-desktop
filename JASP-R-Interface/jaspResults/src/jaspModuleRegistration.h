...
RCPP_MODULE(jaspResults)
{
	...
	Rcpp::class_<jaspObject_Interface>("jaspObject")
		...
		.property("errorMessage",					&jaspObject_Interface::getErrorMessage,	
          											&jaspObject_Interface::setErrorMessage,									"A field to set an errorMessage. Error messages set on containers are propagated to the first table or plot in the container. In addition, setting an error message automatically sets an error on the object.")
